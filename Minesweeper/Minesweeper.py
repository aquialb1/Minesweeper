...
class Board:
    def __init__(self, dim_size, num_mines):
        ...
        # initialize loc coordinates (row, col) as empty set
        self.dug = set()

    def make_new_board(self):
        # create new board based on dim size
        ...
        while mines_planted < self.num_mines:
            ...
            col = loc % self.dim_size  # get col based on remainder
